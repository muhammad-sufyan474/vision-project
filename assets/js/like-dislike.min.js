...
! function(s) {
    ...
    i.prototype = {
        ...
        btnDown: function(s) {
            var i = this.getBtn(s);
            i.addClass(this.opts.activeClass), this.opts.reverseMode || this.disable(i)
        },
        btnUp: function(s) {
            var i = this.getBtn(s);
            i.removeClass(this.opts.activeClass), this.opts.reverseMode || this.enable(i)
        },
        enable: function(i) {
            var n = this,
                l = n.opts;
            i.removeClass(l.disabledClass), l.beforeClick && i.on("beforeClick", function(s) {
                ...
                var o = a.hasClass(l.likeBtnClass) ? t : e,
                    ...
                    c = 0,
                    b = 0;
                o === t ? h ? (n.btnUp(t), c = -1) : (r && (n.btnUp(e), b = -1), n.btnDown(t), c = 1, d = 1) : h ? (n.btnUp(e), b = -1) : (r && (n.btnUp(t), c = -1), n.btnDown(e), b = 1, d = -1), l.click.call(n, d, c, b, i)
            })
        },
        disable: function(s) {
